...
public class CreateAssetServiceOperation extends ServiceOperation
{
    ...
    @Inject
    public CreateAssetServiceOperation(AssetDao assetDao,
    ...
    @Override protected JsonNode doExecute(JsonNode jsonRequest)
    {
        ...
        Asset asset = getAssetEntity(jsonRequest, location, contact, propertyType, status, model, brand, operatingSystem);
    ...
    private Asset getAssetEntity(JsonNode jsonRequest, Location location, Contact contact, PropertyType propertyType, Status status, Model model, Brand brand, OperatingSystem operatingSystem)
    {
