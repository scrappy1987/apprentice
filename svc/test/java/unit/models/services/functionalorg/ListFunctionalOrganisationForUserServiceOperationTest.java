 ...
 */
public class ListFunctionalOrganisationForUserServiceOperationTest {
    ...
    private void createListFunctionOrganisationForUserServiceOperation()
    {
        ...
        Mockito.when(functionalOrganisationDao.findFunctionalOrganistionsForUser(Mockito.anyObject())).thenReturn(functionalOrganisations);
